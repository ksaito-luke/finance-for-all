...
window.COURSES = {
  ...
  boki3: {
    ...
    examTitle: '日商簿記3級 合格',
    totalHours: 90,
    lead: '日商簿記3級は、<strong>すべてのビジネスパーソンの「共通言語」</strong>となる会計の基礎資格です。簿記をまったく学んだことのない方でも、3か月で合格レベルに到達できるよう、動画・テキスト・演習・模試を一本道のロードマップで提供します。',
    skills: [
    ...
    roadmap: [
      ['done', '1か月目 ・ 第1〜2章', '簿記の基礎を固める', '仕訳・勘定科目・試算表まで。毎日30分の学習で土台を作ります。', ['動画 14本', '確認問題 40問'], '完了'],
      ['active', '2か月目 ・ 第3〜4章', '決算処理をマスター', '決算整理・精算表・財務諸表の作成。試験で頻出の重要論点です。', ['動画 18本', '確認問題 60問', 'check:第1回模試'], '学習中'],
  ...
  boki2: {
    ...
    roadmap: [
      ['active', '1〜2か月目 ・ 商業簿記', '商業簿記の応用を固める', '株式会社会計・税効果会計など、3級から一歩進んだ論点を学びます。', ['動画 24本', '確認問題 80問'], '学習中'],
      ['todo', '3〜4か月目 ・ 工業簿記', '工業簿記を攻略', '製造原価の流れと原価計算。2級最大の山場を丁寧に解説します。', ['動画 22本', '確認問題 70問', 'check:第1回模試'], ''],
      ['todo', '5か月目 ・ 原価計算', '意思決定に活かす原価計算', '標準原価計算・CVP分析。応用問題への対応力を高めます。', ['動画 14本', '確認問題 50問', 'check:第2回模試'], ''],
  ...
  uscma: {
    ...
    roadmap: [
      ['active', '1〜4か月目 ・ Part1前半', '財務計画と予算管理', '計画立案・予算編成・予測の手法を学びます。Part1の土台です。', ['動画 28本', '確認問題 120問'], '学習中'],
      ['todo', '5〜7か月目 ・ Part1後半', '業績評価とコスト管理', '原価管理・内部統制・分析。Part1の総仕上げに入ります。', ['動画 24本', '確認問題 100問', 'check:Part1模試'], ''],
      ['todo', '8〜11か月目 ・ Part2前半', '財務分析と意思決定', '財務諸表分析・コーポレートファイナンスの中核を学びます。', ['動画 26本', '確認問題 110問'], ''],
      ['todo', '12〜13か月目 ・ Part2後半', 'リスクと投資判断', 'リスク管理・投資意思決定・職業倫理を学びます。', ['動画 20本', '確認問題 90問', 'check:Part2模試'], ''],
  ...
  toeic: {
    ...
    roadmap: [
      ['active', '1〜2か月目 ・ 基礎固め', '文法と頻出語彙', 'Part5対策の文法と、ビジネス頻出語彙を集中インプットします。', ['動画 16本', '確認問題 200問'], '学習中'],
      ['todo', '3〜4か月目 ・ リスニング', 'L セクション攻略', 'Part1〜4の解法。先読みとシャドーイングで聞く力を鍛えます。', ['動画 18本', '確認問題 240問', 'check:第1回模試'], ''],
      ['todo', '5か月目 ・ リーディング', 'R セクション攻略', 'Part6・7の長文速読。設問タイプ別の解法を習得します。', ['動画 14本', '確認問題 220問', 'check:第2回模試'], ''],
